...
static void
add_matches_to_flow_table__(struct hmap *matches, size_t conj_id_ofs,
                            uint8_t ptable, bool ingress,
                            const struct sbrec_datapath_binding *dp,
                            const struct uuid *lflow_uuid,
                          ...
                          struct lflow_ctx_out *l_ctx_out)
{
    ...
    add_matches_to_flow_table__(matches, conj_id_ofs, ptable, ingress, dp,
                          ...
                          struct lflow_ctx_out *l_ctx_out)
{
    ...
    add_matches_to_flow_table__(&ctrl_lflow->expr_matches,
                                *l_ctx_out->conj_id_ofs, ptable,
