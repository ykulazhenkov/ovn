...
These instructions have been tested with Fedora 29 and 30, and are also applicable for
...
`ovn-docker`, ``ovn-debuginfo``, ``ovn-central-debuginfo``, ``ovn-host-debuginfo``
and ```ovn-vtep-debuginfo```.
