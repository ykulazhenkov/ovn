                          ...
                          const char *svc_mon_src_ip)
{
    ...
    sbrec_service_monitor_set_src_mac(sbrec_mon, monitor_src_mac);
    free(monitor_src_mac);
    sbrec_service_monitor_set_src_ip(sbrec_mon, svc_mon_src_ip);
    sbrec_service_monitor_set_protocol(sbrec_mon, protocol);
